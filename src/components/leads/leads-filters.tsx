    ...
    <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
      ...
      <div className="relative w-full sm:flex-1 sm:min-w-[220px]">
        ...
        <input
          ...
          className="h-9 w-full rounded-lg border border-border bg-background pl-8 pr-3 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-ring focus:ring-2 focus:ring-ring/50 transition-all"
        />
      </div>

      {/* Filtros em linha em mobile */}
