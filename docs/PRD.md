# FlowSet CRM — Product Requirements Document
...
Construir o FlowSet CRM — uma plataforma web SaaS de gestão de clientes e vendas, multi-empresa, com pipeline visual Kanban, gestão completa de leads e negócios, registro de interações e integração de pagamento para monetização. A solução incluirá:
...
- Página pública de apresentação do FlowSet CRM
...
Referências: HubSpot CRM, PipeDrive.
...
2. Multi-empresa + convite por e-mail
3. Gestão de Leads (CRUD + busca/filtros)
4. Pipeline Kanban (drag-and-drop + persistência)
